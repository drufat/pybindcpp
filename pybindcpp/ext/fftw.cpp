...
fftw(ExtModule &m) {
  ...
  m.fun("fft", [](PyObject *o) -> PyObject * {
    ...
    auto plan = fftw_plan_dft_1d(N, in, out, FFTW_FORWARD, FFTW_ESTIMATE | FFTW_UNALIGNED);
  ...
  m.fun("fft2", [](PyObject *o) -> PyObject * {
    ...
    auto p = fftw_plan_dft_1d(N, NULL, NULL, FFTW_FORWARD, FFTW_ESTIMATE); //| FFTW_UNALIGNED);
